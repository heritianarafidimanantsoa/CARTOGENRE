    ...
    <div class="relative w-full h-screen flex bg-black">
        ...
        <div v-if="showIntroContent" class="relative w-full h-full">
            ...
            >
                ...
                >
                    Un site dédiée à la représentation des expériences vécues
                    des inégalités entre FEMMES ET HOMMES, dans les pratiques,
                    les traitements, la façon de penser et la manière d’être
                    perçu par les autres sur le campus universitaire
                    d’Andrainjato à Fianarantsoa Madagascar.
                </p>
