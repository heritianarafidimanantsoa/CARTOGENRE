    ...
    >
      ...
      <div class="grid grid-cols-3 gap-0.5">
        <button
          ...
          :class="{
            'bg-transparent text-white font-bold': activeTab === tab.id,
            'bg-gray-600 text-white hover:bg-gray-500': activeTab !== tab.id,
      ...
      <!-- Contenu -->
      <div class="flex-1 flex flex-col p-6 justify-center items-center mt-4">
        ...
        <canvas ref="myChart" class="w-full" style="max-height: 300px"></canvas>
      </div>
      ...
      >
        ...
        >
          <p class="font-semibold text-white mb-1 text-center text-[12px]">
            {{ item.label }}:
          </p>
